...
<html>
 ...
 <div>
  ...
  <tr>
    ...
    <!--phototlist开始-->
     <div>
       <table border="0" cellpadding="0" cellspacing="4" id="photolist" align="center">
        <c:forEach var="user" varStatus="su" items="${userListListener}">
            <td>
                <a href="#" target="_blank">
                    <img src="${user.upic}" id="${user.uid}" title="${user.uname}" onMouseOver="xianshi(this)" onMouseOut="huifu(this)" />
                </a>
            </td>
